...
function MobileSidebar({ isOpen, onClose, onToggle }) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`fixed top-0 left-0 h-full w-80 bg-background shadow-2xl transform transition-transform duration-300 ease-in-out z-50 ${
        ...
        <div className="p-6 border-t border-border">
          <button
            ...
            className="flex items-center space-x-3 w-full px-4 py-3 text-red-600 hover:bg-red-500/10 rounded-xl transition-colors"
          >
      ...
      <button
        onClick={onToggle}
        className="fixed top-4 left-4 z-30 p-2 bg-background rounded-xl shadow-lg text-muted-foreground hover:text-foreground transition-colors"
      >
